    ...
    <div className="app">
      ...
      <section id="hero" className="section hero">
        <div className="section-inner">
          ...
          <div className="cta-line reveal delay-4">
            <a className="badge mt-20" href="/SEROBRESUME.pdf" download="SEROBRESUME.pdf">
              Download Resume
            </a>
          </div>
        </div>
      ...
      >
        <div className="skills-orbit" aria-hidden="true">
          <img className="orbit-icon icon-1" src="/react.svg" alt="React" />
          <img className="orbit-icon icon-2" src="/js.svg" alt="JavaScript" />
          <img className="orbit-icon icon-3" src="/node.svg" alt="Node.js" />
          <img className="orbit-icon icon-4" src="/nest.svg" alt="NestJS" />
          <img className="orbit-icon icon-5" src="/next.svg" alt="Next.js" />
          <img className="orbit-icon icon-6" src="/mongodb.svg" alt="MongoDB" />
          <img className="orbit-icon icon-7" src="/aws.svg" alt="AWS" />
          <img className="orbit-icon icon-8" src="/cloud.svg" alt="Cloud" />
          <img className="orbit-icon icon-9" src="/docker.svg" alt="Docker" />
          <img className="orbit-icon icon-10" src="/typescript.svg" alt="TypeScript" />
        </div>
        <div className="section-inner">
